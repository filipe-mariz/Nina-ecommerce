...
// time.
const TOKEN_PATH = 'v3.0/lab-saude-backend/app/Services/Calendar/token.json'
const REFRESH_TOKEN_PATH = 'v3.0/lab-saude-backend/app/Services/Calendar/refresh-token.json'
...
export function authorize() {
  ...
  const GOOGLE_REDIRECT_URI = Env.get('GOOGLE_OAUTH_CLIENT_SECRET', 'https://zeropay.io')
